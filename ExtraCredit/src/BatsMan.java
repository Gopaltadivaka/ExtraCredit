...
public class BatsMan {
	...
	/**
	 * non getter setter method, it calculates the average of batsman, by dividing
	 * the total runs scored by batsman by the total number of matches played by
	 * batsman
	 * 
	 * @return
	 */
	public int getAverage() {
		...
		// else calculate the averrage by dividing the total runs scored by batsman by
		// the total number of matches played by batsman
		else {
